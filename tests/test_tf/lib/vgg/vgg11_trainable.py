...
class Vgg11:
    ...
    def __init__(self, vgg11_npy_path=None, trainable=True, dropout=0.5):
        if vgg11_npy_path is not None:
            self.data_dict = np.load(vgg11_npy_path, encoding='latin1').item()
        else:
            self.data_dict = None
