...
struct LogCapture {
   ...
   LogCapture(const g3::LEVELS &level, g3::SignalType fatal_signal, const char *dump = nullptr);
    ...
    */
   LogCapture(const char *file, const int line, const char *function, const g3::LEVELS &level, const char *expression = "", g3::SignalType fatal_signal = SIGABRT, const char *dump = nullptr);
