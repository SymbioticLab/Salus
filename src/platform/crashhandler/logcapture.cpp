...
LogCapture::LogCapture(const g3::LEVELS &level, g3::SignalType fatal_signal, const char *dump) : LogCapture("", 0, "", level, "", fatal_signal, dump) {
}
 ...
 */
LogCapture::LogCapture(const char *file, const int line, const char *function, const g3::LEVELS &level,
