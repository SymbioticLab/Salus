...
from benchmarks.exps import run_seq, maybe_forced_preset, RunFn, sync_on_pipe, Pause, wait_on_pipe, release_on_pipe
...
def main(argv):
    ...
    for idx, bs in enumerate(batch_sizes):
        with tempfile.TemporaryDirectory() as td:
            ...
            run_seq(scfg.copy(output_dir=FLAGS.save_dir / (name + "-inception4")),
